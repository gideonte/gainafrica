      ...
      <main className="flex-1 pt-20">
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <p className="mt-4 text-lg text-primary-foreground/70 max-w-2xl">
              Download presentations, documents, and other materials from our conferences. Select a year to browse
              available resources.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-background">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            {selectedEvent ? (
              <>
                <h2 className="text-2xl font-bold mb-6">Resources from GAiN Africa {selectedEvent.year}</h2>
                <ResourcesList eventId={selectedEvent._id} />
              </>
            ) : (
              <div className="text-center py-12">
                <p className="text-muted-foreground">Please select a year to view resources.</p>
              </div>
            )}
          </div>
        </section>
